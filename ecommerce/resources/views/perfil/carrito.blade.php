...
<script>
    ...
    if('<?php echo $config->tipo_moneda?>' == 'Pesos'){
        var moneda = 'MXN'; 
                    ...
                    transactions: [
                        {
                            ...
                            description:"Compras en DEALPCs, TOTAL A PAGAR: <?php echo $total?>USD" ,
                        }
                    ]
                }
            });
...
function loyal(){
        var totalp = parseFloat('<?php echo $total ?>');
        var credito= parseFloat('<?php echo $user->credit?>');
        <?php
        ...
        return window.location="../../../../venta/checkout/detalles/"+codigo+"/"+transanccion+"/"+productos+"/"+cantidades+"/"+direccion+'/'+'<?php echo $total?>'+'/'+moneda+'/loyal';
            ...
            alert('NO TIENES EL SALDO SUFICIENTE PARA REALIZAR ESTA COMPRA'); 
        }
    }
</script>
@endpush
