...
<main class="main">
    <div class="banner banner-cat" style="background-image: url('assets/images/banners/banner-top.jpg');">
        <div class="banner-content container">
            <h2 class="banner-subtitle">contamos con <span>200+</span></h2>
            <h1 class="banner-title">
                INCREIBLES promociones
            </h1>
                        ...
                        <div class="collapse show" id="widget-body-4">
                            <div class="widget-body">
                                <ul class="cat-list">
                                    <li>
                                        {!! Form::open(array('url'=>'productos','method'=>'GET','autocomplete'=>'off','role'=>'search'))!!}
                                            <input type="hidden" name="marca" value="amd">
                                            <button type="submit" class="btn-marca">Amd</button>
                                        {{Form::close()}}
                                    </li>
                                    <li>
                                        {!! Form::open(array('url'=>'productos','method'=>'GET','autocomplete'=>'off','role'=>'search'))!!}
                                            <input type="hidden" name="marca" value="intel">
                                            <button type="submit" class="btn-marca">Intel</button>
                                        {{Form::close()}}
                                    </li>
                                    <li>
                                        {!! Form::open(array('url'=>'productos','method'=>'GET','autocomplete'=>'off','role'=>'search'))!!}
                                            <input type="hidden" name="marca" value="microsoft">
                                            <button type="submit" class="btn-marca">Microsoft</button>
                                        {{Form::close()}}
                                    </li>
                                    <li>
                                        {!! Form::open(array('url'=>'productos','method'=>'GET','autocomplete'=>'off','role'=>'search'))!!}
                                    ...
                                    <li>
                                        {!! Form::open(array('url'=>'productos','method'=>'GET','autocomplete'=>'off','role'=>'search'))!!}
                                            <input type="hidden" name="marca" value="adata">
                                            <button type="submit" class="btn-marca">Adata</button>
                                        {{Form::close()}}
                                    </li>
                                    <li>
                                        {!! Form::open(array('url'=>'productos','method'=>'GET','autocomplete'=>'off','role'=>'search'))!!}
                                    ...
                                    <li>
                                        {!! Form::open(array('url'=>'productos','method'=>'GET','autocomplete'=>'off','role'=>'search'))!!}
                                            <input type="hidden" name="marca" value="blitzwolf">
                                            <button type="submit" class="btn-marca">Blitzwolf</button>
                                        {{Form::close()}}
                                    </li>
                                </ul>
                            </div><!-- End .widget-body -->
